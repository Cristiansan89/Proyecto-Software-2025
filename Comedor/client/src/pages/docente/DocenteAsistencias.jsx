  ...
  const generarEnlaceAsistencia = async (nombreGrado, servicio) => {
    try {
      ...
      if (!nuevaVentana) {
        ...
        prompt(
          "Copia este enlace para registrar asistencias:",
          response.data.link
        );
      }
    } catch (error) {
    ...
    <div className="docente-asistencias">
      <div className="page-header">
        <div className="header-left">
          <h1 className="page-title">📋 Gestión de Asistencias</h1>
          <p className="page-subtitle">
            Registra la asistencia de tus alumnos para los servicios de comedor
          </p>
        </div>
      </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <label className="form-label">
                Fecha para registro de asistencias:
              </label>
              <input
                type="date"
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <ul className="list-unstyled">
                <li>
                  <span className="badge bg-success me-2">✅ Sí</span> El alumno
                  asiste al servicio
                </li>
                <li>
                  <span className="badge bg-warning me-2">❌ No</span> El alumno
                  no desea asistir
                </li>
                <li>
                  <span className="badge bg-danger me-2">🚫 Ausente</span> El
                  alumno no se presentó
                </li>
              </ul>
            </div>
          </div>
