...
const proveedorService = {
  ...
  getCalificaciones: async () => {
    try {
      const response = await axiosInstance.get("/proveedores/calificaciones");
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  cambiarEstado: async (id, estado) => {
    const response = await axiosInstance.patch(`/proveedores/${id}/estado`, {
      estado,
    });
    return response.data;
  },
  ...
  getInsumosAsignados: async (id) => {
    const response = await axiosInstance.get(`/proveedores/${id}/insumos`);
    return response.data;
  },
  ...
  getActivos: async () => {
    const response = await axiosInstance.get("/proveedores/activos/list");
    return response.data;
  },
  ...
  searchByName: async (nombre) => {
    const response = await axiosInstance.get(
      `/proveedores/search/by-nombre?nombre=${encodeURIComponent(nombre)}`
    );
    return response.data;
  },
};
