  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className={ComponenteStyle.formSections}>
        <div className={ComponenteStyle.infoCard}>
          <h6 className={ComponenteStyle.infoTitle}>
            <i className="fas fa-building-user"></i> Información del Proveedor
          </h6>

          <div>
            <span className={ComponenteStyle.infoLabel}>
              <i className="fas fa-building"></i>
              Razón Social:{" "}
            </span>
            <span className={ComponenteStyle.infoValue}>
              {proveedor?.razonSocial}
            </span>
          </div>
          <div>
            <span className={ComponenteStyle.infoLabel}>
              <i className="fas fa-id-card"></i>CUIT:{" "}
            </span>
            <span className={ComponenteStyle.infoValue}>{proveedor?.CUIT}</span>
          </div>
        </div>
