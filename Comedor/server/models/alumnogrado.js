...
export class AlumnoGradoModel {
    ...
    static async create({ input }) {
        ...
        try {
            ...
            if (existing.length > 0) {
                throw new Error('El alumno ya está asignado a este grado en el ciclo lectivo actual')
            }
    ...
    static async getAlumnosDisponibles({ cicloLectivo = new Date().getFullYear() }) {
