...
const insumoSchema = z.object({
  nombreInsumo: z
    ...
    .max(100, "El nombre del insumo no puede tener más de 100 caracteres"),
  unidadMedida: z.enum(
    [
      "Kilogramos",
      "Gramos",
  ...
  cantidadActual: z.coerce
    ...
    .default(0)
    .optional(),
  nivelMinimoAlerta: z.coerce
    .number({
      invalid_type_error: "El nivel mínimo de alerta debe ser un número",
    })
    .min(0, "El nivel mínimo de alerta no puede ser negativo")
    .optional(),
