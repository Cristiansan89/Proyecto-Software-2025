...
const proveedorInsumoSchema = z.object({
  ...
  calificacion: z
    .enum(["Excelente", "Bueno", "Regular", "Malo"], {
      invalid_type_error:
        "La calificación debe ser: Excelente, Bueno, Regular o Malo",
    })
    .optional()
    .nullable(),
...
// Validación específica para el endpoint de calificar
...
export function validateCalificacionProveedorInsumo(object) {
  return calificacionSchema.safeParse(object);
}
