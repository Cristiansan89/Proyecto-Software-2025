...
export const createApp = ({
    ...
    app.use('/api/movimientos-inventarios', createMovimientoInventarioRouter({ movimientoInventarioModel }))
    app.use('/api/parametros-sistemas', createParametroSistemaRouter({ parametroSistemaModel }))
    ...
    app.use('/api/planificacion-menus', createPlanificacionMenuRouter({ planificacionMenuModel }))
    app.use('/api/proveedores', createProveedorRouter({ proveedorModel }))
    app.use('/api/recetas', createRecetaRouter({ recetaModel }))
    app.use('/api/registros-asistencias', createRegistroAsistenciaRouter({ registroAsistenciaModel }))
