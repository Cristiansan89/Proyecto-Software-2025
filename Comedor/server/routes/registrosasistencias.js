...
export const createRegistroAsistenciaRouter = ({ registroAsistenciaModel }) => {
  ...
  registrosAsistenciasRouter.get(
    "/estadisticas",
    registroAsistenciaController.getEstadisticas
  );
  registrosAsistenciasRouter.get(
    "/verificar-completas",
    registroAsistenciaController.verificarCompletas
  );
  registrosAsistenciasRouter.get(
    "/fecha/:fecha",
    registroAsistenciaController.getByFecha
  );
  registrosAsistenciasRouter.get(
    "/persona/:id_persona",
    registroAsistenciaController.getByPersona
  );
  registrosAsistenciasRouter.get(
    "/servicio/:id_servicio/fecha/:fecha",
    registroAsistenciaController.getByServicioFecha
  );
  registrosAsistenciasRouter.post(
    "/marcar-asistencia",
    registroAsistenciaController.marcarAsistencia
  );

  // Rutas básicas CRUD (van DESPUÉS de las especializadas)
  ...
  registrosAsistenciasRouter.delete(
    "/:id",
    registroAsistenciaController.delete
  );
