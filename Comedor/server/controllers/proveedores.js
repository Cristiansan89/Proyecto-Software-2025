...
import { validateProveedor, validatePartialProveedor, validateAsignarInsumos } from '../schemas/proveedores.js'
...
export class ProveedorController {
    ...
    cambiarEstado = async (req, res) => {
        try {
            ...
            const updated = await this.proveedorModel.update({ id, input: { estado } })
            res.json(updated)
        } catch (error) {
    ...
    asignarInsumos = async (req, res) => {
        try {
            ...
            const insumosAsignados = await this.proveedorModel.getInsumosAsignados({ id })
            res.json({
