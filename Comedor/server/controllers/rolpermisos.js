...
export class RolPermisoController {
    ...
    delete = async (req, res) => {
        try {
            ...
            return res.json({ message: 'Relación rol-permiso eliminada correctamente' })
        } catch (error) {
    ...
    getRolesByPermiso = async (req, res) => {
        try {
            ...
            const roles = await this.rolPermisoModel.getRolesByPermiso({ id_permiso })
            res.json(roles)
        } catch (error) {
    ...
    asignarPermisosRol = async (req, res) => {
        try {
            ...
            const resultado = await this.rolPermisoModel.asignarPermisosRol({ id_rol, permisos })
    ...
    revocarPermisoRol = async (req, res) => {
        try {
            ...
            const revocado = await this.rolPermisoModel.revocarPermisoRol({ id_rol, id_permiso })
