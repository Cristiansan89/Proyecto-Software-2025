...
import {
  validateDocenteGrado,
  validatePartialDocenteGrado,
} from "../schemas/docentegrado.js";
  ...
  static async create(req, res) {
    try {
      ...
      const normalizedData = {
        ...req.body,
        cicloLectivo: DocenteGradoController.normalizeFecha(
          req.body.cicloLectivo
        ),
        fechaAsignado: DocenteGradoController.normalizeFecha(
          req.body.fechaAsignado
        ),
      };
