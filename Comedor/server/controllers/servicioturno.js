export class ServicioTurnoController {
  ...
  getTurnosByServicio = async (req, res) => {
    try {
      ...
      const turnos = await this.servicioTurnoModel.getTurnosByServicio({
        idServicio,
      });
      res.json(turnos);
    } catch (error) {
  ...
  getServiciosByTurno = async (req, res) => {
    try {
      ...
      const servicios = await this.servicioTurnoModel.getServiciosByTurno({
        idTurno,
      });
      res.json(servicios);
    } catch (error) {
  ...
  delete = async (req, res) => {
    try {
      ...
      const deleted = await this.servicioTurnoModel.delete({
        idServicio,
        idTurno,
      });
  ...
  deleteByServicio = async (req, res) => {
    try {
      const { idServicio } = req.params;
      const deletedCount = await this.servicioTurnoModel.deleteByServicio({
        idServicio,
      });
  ...
  deleteByTurno = async (req, res) => {
    try {
      const { idTurno } = req.params;
      const deletedCount = await this.servicioTurnoModel.deleteByTurno({
        idTurno,
      });
